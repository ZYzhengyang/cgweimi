...
const createHierarchicalCategories = async () => {
  const categoryHierarchy = {
    '基础动作': ['基础行走', '基础奔跑', '基础姿态', '基础站立', '基础手势', '基础动作', '基础表情', '基础蹲伏', '基础俯卧', '基础待机', '基础转身', '基础跳跃', '基础蹲下'],
    '战斗动作': ['步枪', '剑类', '拳击', '格斗', '受伤类', '重击受伤', '手枪', '弓箭', '冷兵器', '热兵器', '近战类', '防御类', '格挡', '闪避', '匕首', '长矛', '魔法武器', '擒拿'],
    '舞蹈动作': ['街舞类', '嘻哈舞类', '民族舞类', '现代舞类', '爵士', '萨尔萨舞', '肚皮舞', '卡波耶拉', '舞蹈动作'],
    '表演动作': ['T台行走', 'T台动作', 'T台待机', '表演动作', '机器人表演', '定格动作'],
    '运动动作': ['运动类', '健身类', '举重', '深蹲', '卷腹', '棒球', '橄榄球', '足球', '高尔夫', '摔跤', '运动竞技', '休闲类'],
    '特殊角色': ['僵尸类', '僵尸行走', '僵尸待机', '变异体待机', '变异体攻击', '变异体死亡', '特殊角色'],
    '移动动作': ['方向变化', '蹲伏移动', '蹲伏观察', '俯卧移动', '潜行', '爬行', '攀爬', '跳跃', '特技跳跃', '空翻', '翻滚', '滑步动作', '特技类', '冲刺'],
    '表情动作': ['复杂表情', '开心', '悲伤', '生气', '惊讶', '害怕', '害羞', '失望', '无聊', '自负'],
    '社交动作': ['社交类', '交谈', '握手', '招手', '挥手', '指向', '敬礼', '鼓掌', '飞吻', '欢呼', '同意', '认可', '提问', '礼仪'],
    '生活动作': ['日常生活', '工作类', '休闲类', '使用物品', '拾取物品', '持物行走', '打电话', '打字', '弹奏乐器', '调酒', '玩牌', '挤牛奶'],
    '死亡动作': ['普通死亡', '爆头死亡', '背后死亡', '被勒', '死亡类', '重击死亡'],
    '驾驶动作': ['驾驶类', '开车', '进入车辆'],
    '掩体动作': ['掩体类', '掩体待机', '掩体移动'],
    '站立动作': ['站立类', '抽搐'],
    '手臂动作': ['手臂动作', '臀部动作'],
