...
const $scrapedContentsRepository: Provider = {
	provide: DI.scrapedContentsRepository,
	useFactory: (db: DataSource) => db.getRepository(MiScrapedContent).extend(miRepository as MiRepository<MiScrapedContent>),
	inject: [DI.db],
};
