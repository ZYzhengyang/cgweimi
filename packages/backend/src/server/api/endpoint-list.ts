...
export * as 'admin/bot/create' from './endpoints/admin/bot/create.js';
...
export * as 'notes/video-timeline' from './endpoints/notes/video-timeline.js';
...
export * as 'admin/analytics' from './endpoints/admin/analytics.js';
