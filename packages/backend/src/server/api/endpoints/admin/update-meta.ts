	...
	properties: {
		...
		clientOptions: {
			...
			properties: {
				...
				entranceVideoShow: { type: 'boolean', nullable: true },
				...
				layoutSections: { type: 'array', nullable: true, items: { type: 'object' } },
				userPermissions: { type: 'object', nullable: true },
				hiddenUIElements: { type: 'object', nullable: true },
				customLabels: { type: 'object', nullable: true },
			},
		},
