		...
		<>
			...
			<html>
				<head>
					...
					<link rel="search" type="application/opensearchdescription+xml" title={props.title || 'CG微米'} href={`${props.config.url}/opensearch.xml`} />
					...
					{props.ogSlot ?? (
						<>
							<meta property="og:title" content={props.title || 'CG微米'} />
