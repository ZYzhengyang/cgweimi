			...
			<div class="_gaps">
				...
				<SearchMarker>
					<MkFolder :defaultOpen="true">
						...
						<template #label><SearchLabel>CG微米 Fan-out Timeline Technology™ (FTT)</SearchLabel></template>
				...
				<SearchMarker>
					<MkFolder :defaultOpen="true">
						<template #icon><SearchIcon><i class="ti ti-bolt"></i></SearchIcon></template>
						<template #label><SearchLabel>CG微米 Reactions Boost Technology™ (RBT)</SearchLabel></template>
