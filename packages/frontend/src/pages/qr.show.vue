...
<div :class="$style.root">
	<div :class="[$style.content]">
		...
		<img v-if="deviceMotionPermissionNeeded" v-flip :class="$style.logo" :src="cgvmisvg" alt="CG微米 Logo" @click="requestDeviceMotion"/>
		<img v-else v-flip :class="$style.logo" :src="cgvmisvg" alt="CG微米 Logo"/>
	</div>
</div>
</template>
...
const qrColor = computed(() => tinycolor(instance.themeColor ?? '#ff6b35'));
