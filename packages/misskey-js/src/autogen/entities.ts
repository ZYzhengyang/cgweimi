...
export type AdminAnalyticsRequest = operations['admin___analytics']['requestBody']['content']['application/json'];
export type AdminAnalyticsResponse = operations['admin___analytics']['responses']['200']['content']['application/json'];
...
export type AdminBotCreateRequest = operations['admin___bot___create']['requestBody']['content']['application/json'];
export type AdminBotCreateResponse = operations['admin___bot___create']['responses']['200']['content']['application/json'];
...
export type AdminScrapingApproveRequest = operations['admin___scraping___approve']['requestBody']['content']['application/json'];
export type AdminScrapingApproveResponse = operations['admin___scraping___approve']['responses']['200']['content']['application/json'];
export type AdminScrapingListRequest = operations['admin___scraping___list']['requestBody']['content']['application/json'];
export type AdminScrapingListResponse = operations['admin___scraping___list']['responses']['200']['content']['application/json'];
export type AdminScrapingRejectRequest = operations['admin___scraping___reject']['requestBody']['content']['application/json'];
export type AdminScrapingRejectResponse = operations['admin___scraping___reject']['responses']['200']['content']['application/json'];
export type AdminScrapingStatsResponse = operations['admin___scraping___stats']['responses']['200']['content']['application/json'];
export type AdminScrapingSyncRequest = operations['admin___scraping___sync']['requestBody']['content']['application/json'];
export type AdminScrapingSyncResponse = operations['admin___scraping___sync']['responses']['200']['content']['application/json'];
...
export type InspirationAssociateRequest = operations['inspiration___associate']['requestBody']['content']['application/json'];
export type InspirationAssociateResponse = operations['inspiration___associate']['responses']['200']['content']['application/json'];
...
export type NotesRepliesCreateRequest = operations['notes___replies___create']['requestBody']['content']['application/json'];
export type NotesRepliesCreateResponse = operations['notes___replies___create']['responses']['200']['content']['application/json'];
...
export type NotesVideoTimelineRequest = operations['notes___video-timeline']['requestBody']['content']['application/json'];
export type NotesVideoTimelineResponse = operations['notes___video-timeline']['responses']['200']['content']['application/json'];
